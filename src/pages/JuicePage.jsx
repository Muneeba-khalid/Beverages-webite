...
// import juiceBanner from '../assets/juicebanner.jpeg';
...
//   const juiceProducts = products.filter(product => product.brand === 'Juice');
...
//       const priceString = item.newPrice.replace(/[^0-9.]/g, '');
...
//         <img src={juiceBanner} alt="Juice Banner" style={styles.bannerImage} />
//         <div style={styles.bannerText}>
//           <h1 style={styles.bannerTitle}>Premium Cold-Pressed Juices</h1>
...
//         <h2 style={styles.sectionTitle}>Our Juice Collection</h2>
...
//                   <FaLeaf /> Cold-pressed, No added sugar, 100% Natural
//                 </p>
...
//                   <span style={styles.modalNewPrice}>{selectedProduct.newPrice}</span>
//                   {selectedProduct.oldPrice && (
//                     <span style={styles.modalOldPrice}>{selectedProduct.oldPrice}</span>
//                   )}
//                 </div>
//                 <p style={styles.description}>
//                   {selectedProduct.description || "Our premium cold-pressed juice is made from the freshest organic fruits and vegetables, carefully selected for maximum flavor and nutritional value. Each bottle is packed with vitamins, minerals, and enzymes to boost your health and energy."}
//                 </p>
...
//                   </div>
//                   <div style={styles.benefitItem}>
//                     <FaLeaf /> No added sugars or preservatives
//                   </div>
//                   <div style={styles.benefitItem}>
//                     <FaLeaf /> High in vitamin C
//                   </div>
//                   <div style={styles.benefitItem}>
//                     <FaLeaf /> 100% Organic ingredients
//                   </div>
//                 </div>
//                 <button 
...
//                   <div style={styles.cartItemPrice}>{item.newPrice}</div>
