...
import milkshakeBanner from '../assets/milkshakebanner2.jpeg'; // Make sure to add this image
...
const MilkshakePage = () => {
  ...
  const milkshakeProducts = products.filter(product => product.brand === 'Milkshake');
  ...
  return (
    <div style={styles.page}>
      <div style={styles.banner}>
        <img src={milkshakeBanner} alt="Milkshake Banner" style={styles.bannerImage} />
        <div style={styles.bannerText}>
          <h1 style={styles.bannerTitle}>Creamy Milkshakes</h1>
      ...
      <div style={styles.productsContainer}>
        <h2 style={styles.sectionTitle}>Our Milkshake Collection</h2>
            ...
            <div style={styles.modalContent}>
              ...
              <div style={styles.modalDetails}>
                ...
                <p style={styles.description}>
                  {selectedProduct.description || "Our premium milkshakes are made with real ice cream and fresh ingredients for the creamiest, most indulgent treat. Each shake is handcrafted to perfection with rich flavors that will satisfy your sweet cravings."}
                </p>
                <div style={styles.modalBenefits}>
                  <div style={styles.benefitItem}>
                    <FaLeaf /> Made with real ice cream
                  </div>
                  <div style={styles.benefitItem}>
                    <FaLeaf /> Thick and creamy texture
                  </div>
                  <div style={styles.benefitItem}>
                    <FaLeaf /> Customizable toppings
                  </div>
                  <div style={styles.benefitItem}>
                    <FaLeaf /> Available in multiple sizes
                  </div>
                </div>
                <button 
