...
import coffeeBanner from '../assets/coffeebanner2.jpeg'; // Make sure to add this image
import { FaShoppingCart, FaTimes, FaStar, FaCoffee, FaPlus, FaMinus, FaChevronRight } from 'react-icons/fa';
...
const CoffeePage = () => {
  ...
  const coffeeProducts = products.filter(product => product.brand === 'Coffee');
  ...
  return (
    <div style={styles.page}>
      <div style={styles.banner}>
        <img src={coffeeBanner} alt="Coffee Banner" style={styles.bannerImage} />
        <div style={styles.bannerText}>
          <h1 style={styles.bannerTitle}>Premium Coffee Collection</h1>
          <p style={styles.bannerSubtitle}>
            <FaCoffee style={{ animation: 'coffeeFloat 3s ease-in-out infinite 1s' }} /> 
            100% Arabica & Rich Blends
          </p>
        </div>
      </div>

      <div style={styles.productsContainer}>
        <h2 style={styles.sectionTitle}>Our Coffee Collection</h2>
            ...
            <div style={styles.modalContent}>
              ...
              <div style={styles.modalDetails}>
                ...
                <p style={styles.description}>
                  {selectedProduct.description || "Our premium coffee is sourced from the finest Arabica beans, carefully roasted to perfection. Each cup delivers a rich, full-bodied flavor with aromatic notes that awaken your senses and provide the perfect energy boost."}
                </p>
                <div style={styles.modalBenefits}>
                  <div style={styles.benefitItem}>
                    <FaCoffee /> 100% Arabica beans
                  </div>
                  <div style={styles.benefitItem}>
                    <FaCoffee /> Freshly roasted
                  </div>
                  <div style={styles.benefitItem}>
                    <FaCoffee /> Rich in antioxidants
                  </div>
                  <div style={styles.benefitItem}>
                    <FaCoffee /> Sustainably sourced
                  </div>
                </div>
                <button 
